...
<div class="row" dir="rtl">
	<div class="alert  col-md-5 col-md-push-3">
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;
		</button>
		<h3 class="text-center">

			لم يتم نشر الاعلان بنجاح يُرجي مراجعة الاخطاء التالية
		</h3>
		<ul>
...
<div class="row text-center" dir="rtl">
	...
	@if($ad->user_id === Auth::id())	
		 ...
		 <a type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#myads-{{$ad->id}}">تعديل</a>

  	<!-- Edit ads -->
  <div class="modal fade" id="myads-{{$ad->id}}" role="dialog">
...
@csrf
	...
	<div class="form-group" id="add-img-{{$ad->id}}">
			...
			@foreach($ad->imgs as $img)	
					...
					<button id="mm" ad-id="{{$ad->id}}" img-id="{{$img->id}}">remove me</button>	
...
$(function(){
	...
	$("body").delegate("button#mm","click",function(e){
			e.preventDefault();	
			let adId=$(this).attr('ad-id')+'/';
